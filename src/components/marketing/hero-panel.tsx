...
export function HeroPanel() {
  ...
  return (
    <div className="rounded-lg border border-blue-100 bg-white p-5 shadow-xl shadow-blue-950/10">
      <div className="flex items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <p className="text-sm font-semibold text-slate-500">Painel estratégico</p>
          <p className="mt-1 text-2xl font-bold text-slate-950">Nota estimada 682</p>
        </div>
        <Badge tone="green">
      ...
      <div className="grid gap-4 py-5 sm:grid-cols-3">
        <div className="rounded-lg bg-blue-50 p-4">
          ...
          <p className="mt-3 text-xs font-semibold uppercase text-blue-800">Foco</p>
        ...
        <div className="rounded-lg bg-violet-50 p-4">
          ...
          <p className="mt-3 text-xs font-semibold uppercase text-violet-800">Semana</p>
        ...
        <div className="rounded-lg bg-emerald-50 p-4">
          ...
          <p className="mt-3 text-xs font-semibold uppercase text-emerald-800">Evolução</p>
      ...
      <div className="mt-5 rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <p className="mt-1 text-sm leading-6 text-slate-600">
          Priorize proporcionalidade antes de avançar para funções. É um gargalo
          recorrente e aparece em problemas de diferentes contextos.
        </p>
      </div>
    </div>
  );
